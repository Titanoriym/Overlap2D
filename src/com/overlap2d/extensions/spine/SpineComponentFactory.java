...
import com.uwsoft.editor.renderer.systems.data.SpineVO;
...
public class SpineComponentFactory extends ComponentFactory {
    ...
    protected SpineObjectComponent createSpineObjectComponent(Entity entity, SpineVO vo) {
        ...
        component.setAnimation(vo.currentAnimationName.length() == 0 ? component.skeletonData.getAnimations().get(0).getName() : vo.currentAnimationName);
    ...
    protected SpineDataComponent createSpineDataComponent(Entity entity, SpineVO vo) {
        ...
        component.currentAnimationName = vo.currentAnimationName.length() == 0 ? spineObjectComponent.skeletonData.getAnimations().get(0).getName() : vo.currentAnimationName;
