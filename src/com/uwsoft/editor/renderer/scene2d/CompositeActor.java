...
public class CompositeActor extends Group {
    ...
    protected com.uwsoft.editor.renderer.systems.data.CompositeItemVO vo;
    ...
    private HashMap<String, com.uwsoft.editor.renderer.systems.data.LayerItemVO> layerMap = new HashMap<String, com.uwsoft.editor.renderer.systems.data.LayerItemVO>();

    public CompositeActor(com.uwsoft.editor.renderer.systems.data.CompositeItemVO vo, IResourceRetriever ir) {
        this(vo, ir, BuiltItemHandler.DEFAULT);
    }

    public CompositeActor(com.uwsoft.editor.renderer.systems.data.CompositeItemVO vo, IResourceRetriever ir, BuiltItemHandler itemHandler) {
    ...
    private CompositeActor(com.uwsoft.editor.renderer.systems.data.CompositeItemVO vo, IResourceRetriever ir, BuiltItemHandler itemHandler, boolean isRoot) {
        ...
        com.uwsoft.editor.renderer.systems.data.ResolutionEntryVO resolutionEntryVO = ir.getLoadedResolution();
    ...
    protected void build(com.uwsoft.editor.renderer.systems.data.CompositeItemVO vo, BuiltItemHandler itemHandler, boolean isRoot) {
    ...
    protected void processMain(Actor actor, com.uwsoft.editor.renderer.systems.data.MainItemVO vo) {
    ...
    protected void buildCoreData(Actor actor, com.uwsoft.editor.renderer.systems.data.MainItemVO vo) {
        ...
        //core data
        com.uwsoft.editor.renderer.systems.data.CoreActorData data = new com.uwsoft.editor.renderer.systems.data.CoreActorData();
    ...
    public com.uwsoft.editor.renderer.systems.data.CompositeItemVO getVo() {
        return vo;
    }
