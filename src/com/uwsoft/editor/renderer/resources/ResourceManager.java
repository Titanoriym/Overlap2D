...
public class ResourceManager implements IResourceLoader, IResourceRetriever {
    ...
    protected com.uwsoft.editor.renderer.systems.data.ProjectInfoVO projectVO;

    protected ArrayList<String> preparedSceneNames = new ArrayList<String>();
    protected HashMap<String, com.uwsoft.editor.renderer.systems.data.SceneVO> loadedSceneVOs = new HashMap<String, com.uwsoft.editor.renderer.systems.data.SceneVO>();
    ...
    public void prepareAssetsToLoad() {
        ...
        for (String preparedSceneName : preparedSceneNames) {
            com.uwsoft.editor.renderer.systems.data.CompositeVO composite = loadedSceneVOs.get(preparedSceneName).composite;
            if (composite == null) {
                continue;
            }
            //
    ...
    @Override
    public com.uwsoft.editor.renderer.systems.data.SceneVO loadSceneVO(String sceneName) {
        FileHandle file = Gdx.files.internal(scenesPath + File.separator + sceneName + ".dt");
        Json json = new Json();
        com.uwsoft.editor.renderer.systems.data.SceneVO sceneVO = json.fromJson(com.uwsoft.editor.renderer.systems.data.SceneVO.class, file.readString());
    ...
    @Override
    public com.uwsoft.editor.renderer.systems.data.ProjectInfoVO loadProjectVO() {

        FileHandle file = Gdx.files.internal("project.dt");
        Json json = new Json();
        projectVO = json.fromJson(com.uwsoft.editor.renderer.systems.data.ProjectInfoVO.class, file.readString());
    ...
    @Override
    public com.uwsoft.editor.renderer.systems.data.SceneVO getSceneVO(String sceneName) {
        return loadedSceneVOs.get(sceneName);
    }

    @Override
    public com.uwsoft.editor.renderer.systems.data.ProjectInfoVO getProjectVO() {
        return projectVO;
    }
