...
public class SceneVO {
    ...
    public com.uwsoft.editor.renderer.systems.data.PhysicsPropertiesVO physicsPropertiesVO = new com.uwsoft.editor.renderer.systems.data.PhysicsPropertiesVO();
    ...
    public SceneVO(SceneVO vo) {
        ...
        physicsPropertiesVO = new com.uwsoft.editor.renderer.systems.data.PhysicsPropertiesVO(vo.physicsPropertiesVO);
